...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function hello(){
      document.getElementById('username').innerText = localStorage.getItem('UserData')
    }
    function removecol(){
      if( document.getElementById('col').classList.contains('remove-col')){
        ...
        document.getElementById('arrow-bar').src = '././media/arrow-bar-right.svg'
      }
    }
    function resize(){
    ...
    function arrow(){
      ...
      if(document.getElementById('dropdownMenuButton').classList.contains('show')==true){
        document.getElementById('arrow').classList.add('arrow-rev')
      }
      if(document.getElementById('dropdownMenuButton').classList.contains('show')==false){
